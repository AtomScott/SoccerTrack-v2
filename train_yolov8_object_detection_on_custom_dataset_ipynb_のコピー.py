# -*- coding: utf-8 -*-
"""train-yolov8-object-detection-on-custom-dataset.ipynb のコピー

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GQ3tDenpm4Yw8ihIztotZBlmaSB-sfCD
...
rf = Roboflow(api_key="NbJ3OM8IOeXajBfUkDQ4")
project = rf.workspace("atom-scott-ix3vx").project("soccertrack-v2-pbqrm")
...
!yolo task=detect mode=train model=yolov8s.pt data={dataset.location}/data.yaml epochs=100 imgsz=1080 plots=True
