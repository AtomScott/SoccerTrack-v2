...
- attributes に player_id (元のCSVのid) を追加

使用方法等は convert_csv_to_gsr_json.py と同様
"""
...
def main():
    ap = argparse.ArgumentParser(
        description="SoccerTrack-v2 の GSR CSV を STC-GS 形式JSONに変換するスクリプト（distorted版）With Player ID"
    )
